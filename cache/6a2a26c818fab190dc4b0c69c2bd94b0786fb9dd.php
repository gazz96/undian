    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex align-items-center justify-content-between mb-3">
                ...
                <div>
                    <a href="<?php echo e(url('participants/form?drawing_id=' . $_GET['drawing_id'] ?? '')); ?>" class="btn btn-primary rounded-pil">TAMBAH</a>
                </div>
            </div>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\undian\views/participant/index.blade.php ENDPATH**/ ?>