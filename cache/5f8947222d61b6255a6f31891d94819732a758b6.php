...
<div class="container py-5">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <form action="<?php echo e(url("drawings")); ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <?php if($drawing->background): ?>
                    <div class="">
                        <img src="<?php echo e(url($drawing->background)); ?>" class="w-100"/>
                    </div>
                    <?php endif; ?>
                </div>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bags1423/public_html/eden/views/drawing/form.blade.php ENDPATH**/ ?>