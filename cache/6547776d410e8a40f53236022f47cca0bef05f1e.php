...
<div style="position: fixed; bottom: 0; border-top: 1px solid #ccc; z-index: 2; background: rgba(255, 255, 255, .5);" class="shadow-lg p-3 w-100 d-flex align-items-center justify-content-between">
    <h3 class="mb-0 fw-bold"><?php echo e($drawing->name); ?></h3>
    <div>
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvaswinner">
  ...
  <div class="offcanvas-body p-0">
        <div class="p-3 sticky-top bg-white w-100 d-flex justify-content-between">
              <a class="btn btn-lg btn-outline-primary me-2 rounded-pill px-4 w-100" href="<?php echo e(url('participants/download-winner/' . $drawing->id)); ?>" download>DOWNLOAD</a>
              <a class="btn btn-lg btn-outline-primary me-2 rounded-pill px-4 w-100" href="<?php echo e(url('participants/reset-winner/' . $drawing->id)); ?>">RESET</a>
        </div>
        <div class="p-3">
        <?php $__currentLoopData = $winners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $winner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="card mb-3">
                <div class="card-body">
                    <span class="badge bg-primary">PEMENANG <?php echo e($winner->winner); ?></span>
                    <h3 class="mb-0 text-primary"><?php echo e($winner->nipp); ?></h3>
                    <p class="mb-0 fw-bold"><?php echo e($winner->name); ?></p>
                    <p class="mb-0"><?php echo e($winner->subarea); ?></p>
                </div>
            </div>
...
<style>
    ...
    body {
        height: 100vh;
        background-image: url('<?php echo e(url($drawing->background)); ?>');
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bags1423/public_html/eden/views/home.blade.php ENDPATH**/ ?>